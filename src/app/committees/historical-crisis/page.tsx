  ...
  return (
    <div className="min-h-screen bg-white relative flex flex-col items-center justify-center font-['Roboto_Condensed']">
      <div className="absolute inset-0 w-full h-[600px]">
        <Image src="/delegate_landscape_2.JPG" alt="Historical Crisis" fill priority className="object-cover w-full h-full" style={{zIndex: 0}} />
      ...
      <div className="relative z-10 w-full flex flex-col items-center pt-[180px] pb-12 px-4 sm:px-8 lg:px-32">
        <div className="w-full max-w-2xl bg-gray-50 rounded-2xl shadow-lg p-10">
          <h1 className="text-4xl font-extrabold text-[#010f71] mb-6 tracking-tight">Historical Crisis</h1>
          <p className="text-lg text-gray-700 mb-8">The Historical Crisis committee tackles pivotal moments in history with real-time crisis updates. (Placeholder text)</p>
